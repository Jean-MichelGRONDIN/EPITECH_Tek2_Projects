...
nts::comp4071::comp4071(std::string name)
{
    ...
    this->_parts.push_back(nts::or_Comp::creatOrComp(name + "or_numero0"));
    this->_parts.push_back(nts::or_Comp::creatOrComp(name + "or_numero1"));
    this->_parts.push_back(nts::or_Comp::creatOrComp(name + "or_numero2"));
    this->_parts.push_back(nts::or_Comp::creatOrComp(name + "or_numero3"));

    this->_name = name;
    this->_type = nts::Componenttype::C4071;
}
...
std::unique_ptr<nts::Component> nts::comp4071::creat4071Comp(const std::string &value)
{
    nts::Component *new_one = new nts::comp4071(value.c_str());
