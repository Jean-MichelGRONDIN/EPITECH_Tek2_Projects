...
nts::comp4011::comp4011(std::string name)
{
    ...
    this->_parts.push_back(nts::nand_Comp::creatNandComp(name + "nand_numero0"));
    this->_parts.push_back(nts::nand_Comp::creatNandComp(name + "nand_numero1"));
    this->_parts.push_back(nts::nand_Comp::creatNandComp(name + "nand_numero2"));
    this->_parts.push_back(nts::nand_Comp::creatNandComp(name + "nand_numero3"));

    this->_name = name;
    this->_type = nts::Componenttype::C4011;
}
...
std::unique_ptr<nts::Component> nts::comp4011::creat4011Comp(const std::string &value)
{
    nts::Component *new_one = new nts::comp4011(value.c_str());
