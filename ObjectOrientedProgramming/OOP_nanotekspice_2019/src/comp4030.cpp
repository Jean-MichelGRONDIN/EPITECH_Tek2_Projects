...
nts::comp4030::comp4030(std::string name)
{
    ...
    this->_parts.push_back(nts::xor_Comp::creatXorComp(name + "xor_numero0"));
    this->_parts.push_back(nts::xor_Comp::creatXorComp(name + "xor_numero1"));
    this->_parts.push_back(nts::xor_Comp::creatXorComp(name + "xor_numero2"));
    this->_parts.push_back(nts::xor_Comp::creatXorComp(name + "xor_numero3"));

    this->_name = name;
    this->_type = nts::Componenttype::C4030;
}
...
std::unique_ptr<nts::Component> nts::comp4030::creat4030Comp(const std::string &value)
{
    nts::Component *new_one = new nts::comp4030(value.c_str());

    return (std::unique_ptr<nts::Component>(new_one));
}

void nts::comp4030::dump() const
{
